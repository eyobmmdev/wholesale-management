...
export default function SaleInvoicePreviewModal({ isOpen, onClose, saleId, invoiceNumber }) {
  ...
  const getShareUrl = async () => {
    ...
    setShareLinkError(null);
    try {
      const response = await api.get(`/sales/${saleId}/invoice/share-link/`);
